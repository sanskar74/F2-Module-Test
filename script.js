let students = [
    { ID: 1, name: 'Tom', age: 21, grade: 'A', degree: 'BBA', email: 'tom@example.com' },
    { ID: 2, name: 'Sanju', age: 22, grade: 'B', degree: 'MCA', email: 'sanju@example.com' },
    { ID: 3, name: 'Jon', age: 20, grade: 'C', degree: 'Btech', email: 'jon@example.com' }
];
let addStudent ;
let editStudent ;
let searchField ;
